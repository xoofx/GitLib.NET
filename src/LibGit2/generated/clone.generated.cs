...
namespace LibGit2
{
    ...
    public static partial class libgit2
    {
        ...
        public delegate int git_repository_create_cb(out git_repository @out, [MarshalAs(UnmanagedType.LPUTF8Str)] string path, int bare, IntPtr payload);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int git_remote_create_cb(out git_remote @out, git_repository repo, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, [MarshalAs(UnmanagedType.LPUTF8Str)] string url, IntPtr payload);
        ...
        [DllImport(LibGit2Name, EntryPoint = "git_clone_init_options", CallingConvention = CallingConvention.Cdecl)]
