...
namespace LibGit2
{
    ...
    public static partial class libgit2
    {
        ...
        [DllImport(LibGit2Name, EntryPoint = "git_mailmap_new", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <returns>0 on success, or an error code</returns>
        public static git_result git_mailmap_add_entry(git_mailmap mm, [MarshalAs(UnmanagedType.LPUTF8Str)] string real_name, [MarshalAs(UnmanagedType.LPUTF8Str)] string real_email, [MarshalAs(UnmanagedType.LPUTF8Str)] string replace_name, [MarshalAs(UnmanagedType.LPUTF8Str)] string replace_email)
        {
            var __result__ = git_mailmap_add_entry__(mm, real_name, real_email, replace_name, replace_email).Check();
            return __result__;
        }
        
        [DllImport(LibGit2Name, EntryPoint = "git_mailmap_add_entry", CallingConvention = CallingConvention.Cdecl)]
        private static extern git_result git_mailmap_add_entry__(git_mailmap mm, [MarshalAs(UnmanagedType.LPUTF8Str)] string real_name, [MarshalAs(UnmanagedType.LPUTF8Str)] string real_email, [MarshalAs(UnmanagedType.LPUTF8Str)] string replace_name, [MarshalAs(UnmanagedType.LPUTF8Str)] string replace_email);
        ...
        /// <returns>0 on success, or an error code</returns>
        public static git_result git_mailmap_from_buffer(out git_mailmap @out, [MarshalAs(UnmanagedType.LPUTF8Str)] string buf, size_t len)
        {
            var __result__ = git_mailmap_from_buffer__(out @out, buf, len).Check();
            return __result__;
        }
        
        [DllImport(LibGit2Name, EntryPoint = "git_mailmap_from_buffer", CallingConvention = CallingConvention.Cdecl)]
        private static extern git_result git_mailmap_from_buffer__(out git_mailmap @out, [MarshalAs(UnmanagedType.LPUTF8Str)] string buf, size_t len);
        ...
        [DllImport(LibGit2Name, EntryPoint = "git_mailmap_from_repository", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// </remarks>
        public static git_result git_mailmap_resolve(out string real_name, out string real_email, git_mailmap mm, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, [MarshalAs(UnmanagedType.LPUTF8Str)] string email)
        {
            var __result__ = git_mailmap_resolve__(out real_name, out real_email, mm, name, email).Check();
            return __result__;
        }
        
        [DllImport(LibGit2Name, EntryPoint = "git_mailmap_resolve", CallingConvention = CallingConvention.Cdecl)]
        private static extern git_result git_mailmap_resolve__(out string real_name, out string real_email, git_mailmap mm, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, [MarshalAs(UnmanagedType.LPUTF8Str)] string email);
        ...
        [DllImport(LibGit2Name, EntryPoint = "git_mailmap_resolve_signature", CallingConvention = CallingConvention.Cdecl)]
