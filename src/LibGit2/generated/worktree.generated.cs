...
namespace LibGit2
{
    ...
    public static partial class libgit2
    {
        ...
        [DllImport(LibGit2Name, EntryPoint = "git_worktree_list", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// <returns>0 or an error code</returns>
        public static git_result git_worktree_lookup(out git_worktree @out, git_repository repo, [MarshalAs(UnmanagedType.LPUTF8Str)] string name)
        {
            var __result__ = git_worktree_lookup__(out @out, repo, name).Check();
            return __result__;
        }
        
        [DllImport(LibGit2Name, EntryPoint = "git_worktree_lookup", CallingConvention = CallingConvention.Cdecl)]
        private static extern git_result git_worktree_lookup__(out git_worktree @out, git_repository repo, [MarshalAs(UnmanagedType.LPUTF8Str)] string name);
        ...
        [DllImport(LibGit2Name, EntryPoint = "git_worktree_add_init_options", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// </remarks>
        public static git_result git_worktree_add(out git_worktree @out, git_repository repo, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, [MarshalAs(UnmanagedType.LPUTF8Str)] string path, in git_worktree_add_options opts)
        {
            var __result__ = git_worktree_add__(out @out, repo, name, path, opts).Check();
            return __result__;
        }
        
        [DllImport(LibGit2Name, EntryPoint = "git_worktree_add", CallingConvention = CallingConvention.Cdecl)]
        private static extern git_result git_worktree_add__(out git_worktree @out, git_repository repo, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, [MarshalAs(UnmanagedType.LPUTF8Str)] string path, in git_worktree_add_options opts);
        ...
        /// </remarks>
        [DllImport(LibGit2Name, CallingConvention = CallingConvention.Cdecl)]
        public static extern int git_worktree_lock(git_worktree wt, [MarshalAs(UnmanagedType.LPUTF8Str)] string reason);
        ...
        [DllImport(LibGit2Name, EntryPoint = "git_worktree_prune_init_options", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(LibGit2Name, EntryPoint = "git_worktree_prune", CallingConvention = CallingConvention.Cdecl)]
