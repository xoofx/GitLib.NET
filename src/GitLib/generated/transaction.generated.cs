...
namespace GitLib
{
    ...
    public static partial class libgit2
    {
        ...
        /// reference.
        /// </remarks>
        public static git_result git_transaction_lock_ref(git_transaction tx, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string refname)
        {
        ...
        private static extern git_result git_transaction_lock_ref__(git_transaction tx, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string refname);
        ...
        /// locked.
        /// </remarks>
        public static git_result git_transaction_set_target(git_transaction tx, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string refname, in git_oid target, in git_signature sig, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string msg)
        {
        ...
        private static extern git_result git_transaction_set_target__(git_transaction tx, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string refname, in git_oid target, in git_signature sig, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string msg);
        ...
        /// locked.
        /// </remarks>
        public static git_result git_transaction_set_symbolic_target(git_transaction tx, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string refname, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string target, in git_signature sig, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string msg)
        {
        ...
        /// </remarks>
        public static git_result git_transaction_set_reflog(git_transaction tx, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string refname, git_reflog reflog)
        {
        ...
        private static extern git_result git_transaction_set_reflog__(git_transaction tx, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string refname, git_reflog reflog);
        ...
        /// <returns>0, GIT_ENOTFOUND if the reference is not among the locked ones, or an error code</returns>
        public static git_result git_transaction_remove(git_transaction tx, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string refname)
        {
        ...
        private static extern git_result git_transaction_remove__(git_transaction tx, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string refname);
