...
namespace GitLib
{
    ...
    public static partial class libgit2
    {
        ...
        public static extern int git_indexer_new(out git_indexer @out, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string path, uint mode, git_odb odb, ref git_indexer_options opts);
