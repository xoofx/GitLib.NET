...
namespace GitLib
{
    ...
    public static partial class libgit2
    {
        ...
        [DllImport(GitLibName, EntryPoint = "git_packbuilder_new", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// </remarks>
        public static git_result git_packbuilder_insert(git_packbuilder pb, in git_oid id, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name)
        {
        ...
        private static extern git_result git_packbuilder_insert__(git_packbuilder pb, in git_oid id, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name);
        ...
        [DllImport(GitLibName, EntryPoint = "git_packbuilder_insert_tree", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(GitLibName, EntryPoint = "git_packbuilder_insert_commit", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(GitLibName, EntryPoint = "git_packbuilder_insert_walk", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// </remarks>
        public static git_result git_packbuilder_insert_recur(git_packbuilder pb, in git_oid id, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name)
        {
        ...
        private static extern git_result git_packbuilder_insert_recur__(git_packbuilder pb, in git_oid id, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name);
        ...
        /// <returns>0 or an error code</returns>
        public static git_result git_packbuilder_write(git_packbuilder pb, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string path, uint mode, git_transfer_progress_cb progress_cb, IntPtr progress_cb_payload)
        {
        ...
        private static extern git_result git_packbuilder_write__(git_packbuilder pb, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string path, uint mode, git_transfer_progress_cb progress_cb, IntPtr progress_cb_payload);
        ...
        [DllImport(GitLibName, EntryPoint = "git_packbuilder_foreach", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(GitLibName, EntryPoint = "git_packbuilder_set_callbacks", CallingConvention = CallingConvention.Cdecl)]
