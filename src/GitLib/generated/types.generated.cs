...
namespace GitLib
{
    ...
    public static partial class libgit2
    {
        ...
        public delegate int git_transport_message_cb([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshallerRelaxedNoCleanup))] string str, int len, IntPtr payload);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int git_transport_certificate_check_cb(ref git_cert cert, int valid, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshallerRelaxedNoCleanup))] string host, IntPtr payload);
        ...
        public partial struct git_writestream
        {
            ...
            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            public delegate int write_delegate(ref git_writestream stream, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshallerRelaxedNoCleanup))] string buffer, size_t len);
