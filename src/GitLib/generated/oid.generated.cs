...
namespace GitLib
{
    ...
    public static partial class libgit2
    {
        ...
        public static git_result git_oid_fromstr(out git_oid @out, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string str)
        {
        ...
        private static extern git_result git_oid_fromstr__(out git_oid @out, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string str);
        ...
        /// <returns>0 or an error code</returns>
        public static git_result git_oid_fromstrp(out git_oid @out, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string str)
        {
        ...
        private static extern git_result git_oid_fromstrp__(out git_oid @out, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string str);
        ...
        /// </remarks>
        public static git_result git_oid_fromstrn(out git_oid @out, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string str, size_t length)
        {
        ...
        private static extern git_result git_oid_fromstrn__(out git_oid @out, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string str, size_t length);
        ...
        [DllImport(GitLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int git_oid_streq(in git_oid id, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string str);
        ...
        [DllImport(GitLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int git_oid_strcmp(in git_oid id, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string str);
        ...
        /// </remarks>
        [DllImport(GitLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int git_oid_shorten_add(git_oid_shorten os, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string text_id);
