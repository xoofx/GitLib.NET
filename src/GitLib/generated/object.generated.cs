...
namespace GitLib
{
    ...
    public static partial class libgit2
    {
        ...
        [DllImport(GitLibName, EntryPoint = "git_object_lookup", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(GitLibName, EntryPoint = "git_object_lookup_prefix", CallingConvention = CallingConvention.Cdecl)]
        ...
        public static git_result git_object_lookup_bypath(out git_object @out, git_object treeish, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string path, git_object_t type)
        {
        ...
        private static extern git_result git_object_lookup_bypath__(out git_object @out, git_object treeish, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string path, git_object_t type);
        ...
        [DllImport(GitLibName, EntryPoint = "git_object_short_id", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(GitLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern git_object_t git_object_string2type([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string str);
        ...
        [DllImport(GitLibName, EntryPoint = "git_object_peel", CallingConvention = CallingConvention.Cdecl)]
