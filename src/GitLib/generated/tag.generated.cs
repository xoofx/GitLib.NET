...
namespace GitLib
{
    ...
    public static partial class libgit2
    {
        ...
        public delegate int git_tag_foreach_cb([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerRelaxedNoCleanup))] string name, ref git_oid oid, IntPtr payload);
        ...
        /// </remarks>
        public static git_result git_tag_create(ref git_oid oid, git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string tag_name, git_object target, in git_signature tagger, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string message, int force)
        {
        ...
        public static git_result git_tag_create_frombuffer(ref git_oid oid, git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string buffer, int force)
        {
        ...
        private static extern git_result git_tag_create_frombuffer__(ref git_oid oid, git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string buffer, int force);
        ...
        /// </remarks>
        public static git_result git_tag_create_lightweight(ref git_oid oid, git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string tag_name, git_object target, int force)
        {
        ...
        private static extern git_result git_tag_create_lightweight__(ref git_oid oid, git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string tag_name, git_object target, int force);
        ...
        /// See `git_tag_create()` for rules about valid names.
        /// </remarks>
        public static git_result git_tag_delete(git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string tag_name)
        {
        ...
        private static extern git_result git_tag_delete__(git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string tag_name);
        ...
        /// `git_strarray_free`.
        /// </remarks>
        public static git_result git_tag_list_match(out string[] tag_names, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string pattern, git_repository repo)
        {
            git_strarray tag_names__;
        ...
        private static extern git_result git_tag_list_match__(out git_strarray tag_names, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string pattern, git_repository repo);
