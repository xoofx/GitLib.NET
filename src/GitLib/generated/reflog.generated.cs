...
namespace GitLib
{
    ...
    public static partial class libgit2
    {
        ...
        /// git_reflog_free().
        /// </remarks>
        public static git_result git_reflog_read(out git_reflog @out, git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name)
        {
        ...
        private static extern git_result git_reflog_read__(out git_reflog @out, git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name);
        ...
        /// </remarks>
        public static git_result git_reflog_append(git_reflog reflog, in git_oid id, in git_signature committer, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string msg)
        {
        ...
        private static extern git_result git_reflog_append__(git_reflog reflog, in git_oid id, in git_signature committer, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string msg);
        ...
        /// </remarks>
        public static git_result git_reflog_rename(git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string old_name, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name)
        {
        ...
        private static extern git_result git_reflog_rename__(git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string old_name, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name);
        ...
        /// <returns>0 or an error code</returns>
        public static git_result git_reflog_delete(git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name)
        {
        ...
        private static extern git_result git_reflog_delete__(git_repository repo, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string name);
