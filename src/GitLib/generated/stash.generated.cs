...
namespace GitLib
{
    ...
    public static partial class libgit2
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int git_stash_cb(size_t index, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerRelaxedNoCleanup))] string message, in git_oid stash_id, IntPtr payload);
        ...
        public static git_result git_stash_save(out git_oid @out, git_repository repo, in git_signature stasher, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string message, uint flags)
        {
        ...
        private static extern git_result git_stash_save__(out git_oid @out, git_repository repo, in git_signature stasher, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8MarshalerStrict))] string message, uint flags);
